...
//        } catch (Exception e) {
//            Log.e("RepocketSDK","Error: " + e.getMessage());
//        }
//    }
//
...
//
//                peerService.addConnectedListener(() -> {
//                    Log.d("RepocketSDK","peer connected");
//                });
//                peerService.addConnectingListener(() -> {
//                    Log.d("RepocketSDK","peer resetting");
//                });
//                peerService.addDisconnectedListener(() -> {
//                    Log.d("RepocketSDK","peer disconnected");
//                });
//                peerService.addRefreshTokenRequiredListener(() -> {
//                    Log.d("RepocketSDK","peer refresh_token_required");
//                });
//
//                peerService.createPeer().get();
//            } else {
