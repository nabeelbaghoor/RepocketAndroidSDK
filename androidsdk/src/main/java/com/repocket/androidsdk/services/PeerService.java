...
public class PeerService {
    ...
    private void onConnectionEstablishedDebounce() throws JSONException, IOException {
    ...
    private void _markPeerAsAlive() throws JSONException, IOException {
        Log.d("PeerService", "markPeerAsAlive -> start - " + peerId);
        Response response = Services.PeerManagerApiService.Post("peer/markPeerAsAlive", new HashMap<String, Object>() {{
            put("peerId", peerId);
        }});
